...
const config = useDialKit(
  ...
  {
    text: "INSPIRA",
    strokeWidth: range(0.75, 0.1, 3, 0.05),
    duration: range(200, 50, 1000, 25),
    opacity: range(0.75, 0, 1, 0.05),
  },
  { id: "text-hover-effect", persist: false },
);
</script>
...
<template>
  <ComponentPlayground>
    <template #component>
      <TextHoverEffectDemo v-bind="config" />
    </template>
